...
class JointSegmentationInsertionProblem(util.SearchProblem):
    ...
    def succ_and_cost(self, state):
        ...
        #     word = self.query[pos: pos+step+1]
        #     fills = self.possibleFills(word) | {word}
        #
        #     for fill in fills:
...
if __name__ == '__main__':
    ...
    problem = JointSegmentationInsertionProblem('whtsp', smoothCost, possibleFills)
